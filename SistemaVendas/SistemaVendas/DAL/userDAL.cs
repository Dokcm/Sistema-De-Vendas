...
namespace SistemaVendas.DAL
{
    class userDAL
    {
        ...
        #endregion
        #region inserindo dados de banco de dados
        ...
        #endregion
        #region atualizar dados de banco de dados
        public bool Update(userBLL u)
        {
            ...
            try
            {
                String sql = "UPDATE tbl_usuarios SET nome=@nome,s_nome=@s_nome,email=@email,usuario=@usuario,senha=@senha,contato=@contato,endereco=@endereco,sexo=@sexo,usuario_tipo=@usuario_tipo,add_data=@add_data,add_por=@add_por WHERE id=@id";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        #endregion    
        #region deletar dados de banco de dados
        ...
        #endregion
        #region pesquisar cadastro no banco de dados
        public DataTable Pesquisar( string keywords)
        {
            ...
            try
            {
                String sql = "Select * from tbl_usuarios WHERE id LIKE '%"+keywords+"%' or nome LIKE '%"+keywords+"%' or s_nome LIKE '%"+keywords+"%' ";
                SqlCommand cmd = new SqlCommand(sql, conn);
                SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                conn.Open();
                adapter.Fill(dt);
